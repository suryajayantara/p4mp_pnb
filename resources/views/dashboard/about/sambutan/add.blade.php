    ...
    <div class="card-body">
        ...
        <form action="{{ route('about.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <label for="exampleInputEmail1" class="form-label">Judul Sambutan</label>
                <input name="title" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                <label for="exampleInputEmail1" class="form-label my-3">Isi Sambutan</label>
          ...
          <a href="/sambutan"><button type="button" class="btn btn-lg w-100 btn-danger">Kembali</button></a>
    </div>
</div>
