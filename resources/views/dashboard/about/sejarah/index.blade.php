...
<div class="row my-3 mx-auto">
    ...
    <div class="col-md-12">
        @if ($posts->count() == 0)
            <a href="{{ route('about.create') }}?category=sejarah" class="btn btn-success" style="float: right">Tambah</a>
        @else
            ...
            <div class="card-body mx-3">
                <div class="row mb-4">
                    @foreach ($posts as $post)
                        <div class="col-md-12">
                            <a href="/sejarah/edit/{{ $post->id }}" class="btn btn-success" style="float: right">Edit</a>
                        </div>
                        <div class="col-md-12">
