    ...
    <div class="card-body">
        ...
        {{ Form::model($certification_data, array('route' => array('certifications.update', $certification_data->id), 'method' => 'PUT')) }}
            ...
            <div class="mb-3">
                ...
                <input name="level" type="Name" value="{{ $certification_data->level }}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                <textarea name="result" class="form-control my-3" placeholder="Masukan Deksripsi Jurusan Disini" id="floatingTextarea2" style="height: 100px">{{ $certification_data->result }}</textarea>
                <label for="exampleInputEmail1" class="form-label">Masa Berlaku (Awal)</label>
                <input name="start_date" type="date" value="{{ $certification_data->start_date }}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                <label for="exampleInputEmail1" class="form-label">Masa Berlaku (Akhir)</label>
                <input name="end_date" type="date" value="{{ $certification_data->end_date }}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
